...
'A simple online invoice interface': 'A simple online invoice interface',
'A simple online invoice interface example': 'A simple online invoice interface example',
'About': 'Acerca de',
'about': 'acerca de',
...
'Invoice %(invoice_id)s is %(status)s': 'Invoice %(invoice_id)s is %(status)s',
'Invoice details': 'Invoice details',
'Invoice Id': 'Invoice Id',
'Invoice No. %(number)s': 'Invoice No. %(number)s',
'Invoice no. %(number)s': 'Invoice no. %(number)s',
'Invoice No. %(number)s header': 'Invoice No. %(number)s header',
'Invoice now set to %(status)s': 'Invoice now set to %(status)s',
'Is Active': 'Is Active',
'JSON': 'JSON',
