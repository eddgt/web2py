...
'detalle factura': 'detalle factura',
...
'exposes': 'expone',
'extends': 'extiende',
'Factura %(factura_id)s is %(status)s': 'Factura %(factura_id)s is %(status)s',
'Factura Id': 'Factura Id',
'Factura No. %(numero)s': 'Factura No. %(numero)s',
'Facturas': 'Facturas',
'failed to reload module': 'la recarga del módulo ha fallado',
'FAQ': 'FAQ',
'Favorite musics': 'Favorite musics',
