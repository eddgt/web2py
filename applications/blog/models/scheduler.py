...
def enviaCorreo():
        ...
        cc=['clientes.pa@televida.biz','scuchillas@televida.biz','msamayoa@televida.biz','dcamacho@televida.biz','soporte247@televida.biz'],
          message='<html><body><p>Buen día <br> <br> Adjunto envío reporte "Base usuarios Recargamania Movistar PA 2014" al dia de hoy  <br>  <br> Saludos, <br>  <br>Osman E. Ulloa <br>Soporte Regional Televida</p></body> </html>',
